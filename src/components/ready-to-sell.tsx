  ...
  return (
    <section className='relative flex items-center justify-between mt-[120px] container'>
      ...
      <div className=''>
        ...
        />
        <div className='ml-8 '>
          <p className=' w-[413px] font-normal text-base text-brandBlue-100'>
            Houses recommended by our partners that have been curated to become
            the home of your dreams!
          </p>
          <div className='mt-4 space-y-8'>
            <h6 className='text-base font-semibold text-brandBlue-700'>
              House Detail
            </h6>
            <div className='grid grid-cols-2 w-[524px] gap-3'>
              {HOUSE_DETAIL_DATA.map((houseDetail) => (
                <HouseDetailItem key={houseDetail.id} {...houseDetail} />
              ))}
            </div>
